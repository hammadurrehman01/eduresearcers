...
function ThankOrder() {
  ...
  return (
    <div
      style={{
        backgroundImage: "url('/imgs/banner-im.webp')",
        backgroundSize: "cover",
        backgroundPosition: "center",
      }}
      className="flex  flex-col items-center justify-center h-screen bg-background px-4 pb-24 pt-32 md:pt-2 sm:px-6 lg:px-8"
    >
      <div className="mx-auto max-w-screen-xl text-center scale-90 md:scale-100">
        ...
        <h1 className="pt-3 lg:w-[610px] mx-auto text-lg font-medium  sm:text-xl">
          Thank you for your order! Enjoy a special 45% discount. Check WhatsApp
          at <span className="font-bold">{phone}</span> for details!
        </h1>
        <p className="md:mt-4 mt-2 ">
          Thank you for your purchase! Feel free to reach out with any
          questions.{" "}
        </p>
