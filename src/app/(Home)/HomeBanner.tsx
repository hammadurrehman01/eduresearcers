"use client";
import { CheckCircle, ShoppingCartIcon, Star, Users } from "lucide-react";
...
export function HomeBanner({ city, number, locationDetails }: any) {
          ...
          <div className=" grid lg:grid-cols-2 grid-cols-1 gap-3 lg:py-10 py-3">
            ...
            <div className="lg:py-4 lg:pl-24 px-5 scale-90 md:scale-100">
              ...
              <div className="md:flex-row md:justify-start gap-3 flex flex-col justify-center items-center scale-[.85] md:scale-100 lg:mt-4">
                ...
                <button
                  onClick={tawkToClick}
                  className="bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 flex font-medium items-center py-[13px] px-6 rounded-lg md:hover:scale-105 md:scale-100 scale-90 hover:scale-95 transition ease-in duration-200 delay-200  gap-2 w-full justify-center md:justify-start text-sm"
                >
                  <IoChatbubbleEllipses className="w-6 h-6" /> Discuss With
                  Experts
                </button>
              </div>
              <div className="font-medium text-muted-foreground text-center md:text-start pt-4">
                <span className="font-bold text-[#111827] dark:text-zinc-100">
                  Achieve A+ Results, <br className="lg:hidden block" />{" "}
                  <span className="text-muted-foreground font-medium">
                    We Are Best Academic Helpers !
                  </span>
                </span>
              </div>
              ...
              <div
                onClick={tawkToClick}
                className=" bg-zinc-50 dark:bg-gray-900  p-5 rounded-lg shadow-lg w-full  mx-auto mt-6 lg:block hidden"
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ul className="mt-2 space-y-2">
                      ...
                      <li className="flex items-center gap-2 text-sm">
                        <CheckCircle className="text-green-400 w-5 h-5" /> Time
                        Flexibility
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="mt-2 space-y-2">
                      <li className="flex items-center gap-2 text-sm">
                        <CheckCircle className="text-green-400 w-5 h-5 " /> Very
                        Low Pricing
                      </li>
                      <li className="flex items-center gap-2 text-sm">
                        <CheckCircle className="text-green-400 w-5 h-5" />{" "}
            ...
            <div>
              <div className="flex justify-center px-3">
                ...
                <div
                  className={`transition duration-200 ease-in  ${
                    highlightForm
                      ? "border-2 border-orange-500 shadow-xl scale-95 md:scale-105 rounded-3xl"
                      : ""
                  }`}
                >
                  <DiscountForm locationDetails={locationDetails} />
                </div>
              </div>
              ...
              <div className="px-5 scale-90 md:scale-100">
                <div
                  onClick={tawkToClick}
                  className=" bg-zinc-50 dark:bg-gray-900  p-5 rounded-lg shadow-lg w-full  mx-auto mt-6 lg:hidden block"
                >
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs pt-1 pb-1 ps-4">
                        Online to help you 24x7
                      </p>
                      <ul className="mt-2 space-y-2">
                        <li className="flex items-center gap-2 text-sm">
                    ...
                    <div>
                      <h3 className="text-xl font-bold flex items-center gap-2">
                        <Star className="text-yellow-400" /> Rated{" "}
                        <br className="md:hidden block" /> 4.9/5
                      </h3>
                      <p className="text-xs pt-1 pb-1 ps-4">
                        Out of 3098 Reviews
                      </p>
...
export function HelpDesk() {
  ...
  return (
    <button
      ...
      className="bg-zinc-900 dark:bg-zinc-100 text-zinc-100 dark:text-zinc-900 flex font-medium items-center py-[13px] px-6 rounded-lg md:hover:scale-105 md:scale-100 scale-90 hover:scale-95 transition ease-in duration-200 delay-200 w-full lg:w-auto justify-center lg:justify-start gap-2"
    >
